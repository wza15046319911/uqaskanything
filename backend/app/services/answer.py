...
# requirement_type whitelist: values in program_course -> Chinese label (deterministic mapping, not given to the model)
_REQ_TYPE_LABEL = {
    "core": "必修",
    "compulsory": "必修",
    "required": "必修",
...
def _req_type_label(raw) -> str | None:
    """Map the raw requirement_type value to a Chinese label; unknown values are returned as is, empty returns None."""
    if not raw:
        return None
